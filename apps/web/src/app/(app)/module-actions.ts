 ...
 * here, "AgriPro Core" in the switcher was just a link to `/agripro`, and the
 * very next page a farm visited would fall back to its default species
 * module and put the whole nav group straight back.
 */
